...
SECRET_KEY = '$#$f1hnto!ptdno+bb7wlfyeuopbvlxyb^#^!ypol+936^hgnh'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'dojoreads_postgres_db', # nombre de la base de datos, se creará en el servidor de Postgres a continuación
